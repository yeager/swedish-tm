...
This is an ongoing complete language review of Translation Project's 146 Swedish domains. 23,696 of 127,367 active entries have been individually read. The review is not complete. This update corrects 6,318 confirmed English–Swedish pairs in both `sv-tp.po` and `sv-tp.tmx`.
